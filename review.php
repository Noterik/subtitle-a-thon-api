        ...
        case "getassignedvideos":
            ...
            if (mysqli_num_rows($result) === 1) {
                ...
                if ($row['reviewer'] == true) {
                    ...
                    $sql = "SELECT i.id, i.item_key, i.eupsid, i.language, i.characters, i.manifest, i.eventid, i.itemid, i.reviewerid, u.username FROM item_subtitles AS i LEFT JOIN users AS u ON i.userid = u.userid WHERE finalized = TRUE AND (eventid = 5 OR eventid = 6) AND i.reviewerid = ".$reviewerid;
                    $result = $conn->query($sql);
